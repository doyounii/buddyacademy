...
<head>
  ...
  <style>
    <%-- 본문 영역 스타일 --%>
    .wrap .content .title { width: 450px; margin: 10px auto; font-family: Sans-Serif; font-size: 2em; font-weight: bold; text-align: center; color:orange; padding-top:20px; padding-bottom:34px; }
